                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    while ($announce = mysqli_fetch_assoc($announceResult)) {
                          $id = $announce['id']; // Use correct id for update and delete links
                    ...
                    <tr>
                        ...
                        <td>
                          <a href='update_annonce.php?id=<?php echo $id;?>' class='btn btn-primary btn-sm'>Update</a>
                          <a href='deleteannonce.php?id=<?php echo $id;?>' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this file?\");'>Delete</a>
                        </td>
                        <td>
                        <?php
                                    if ($announce['is_active'] == '0') { ?>
