...
if (isset($_GET['id'])) {
    ...
    $result = mysqli_query($conn, "SELECT * FROM fixed_db WHERE id = $id");
    $static = mysqli_fetch_assoc($result);
}
...
if (isset($_POST['update']) && isset($_FILES['filename'])) {
    ...
    if (move_uploaded_file($fileTmp, $uploadPath)) {
        ...
        $stmt = $conn->prepare("UPDATE fixed_db SET filename = ?, filetype = ?, filesize = ? WHERE id = ?");
            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?= htmlspecialchars($static['imagetype']); ?>" disabled>
                </div>
                <div class="form-group">
                  <label for="filesize">Current Filesize</label>
                  <input type="text" class="form-control" value="<?= htmlspecialchars($static['imagesize']); ?>" disabled>
                </div>
                <div class="card-footer">
                <button type="submit" name="update" class="btn btn-success">Update</button>
                <a href="imagetable.php" class="btn btn-secondary">Cancel</a>
</div>
              </form>
            </div>
          </div>
